...
function _buildGRP(t0, l, r){
  return [
    ...
    {h:"👔 C-Level & Executive Search",hc:"ex-hdr",list:[
      ...
      {n:"Spencer Stuart",i:"🌐",s:"Global CxO",aw:0,u:()=>`https://de.spencerstuart.com/what-we-do/our-capabilities/executive-search`},
      {n:"Egon Zehnder",i:"⭐",s:"CxO & Board",aw:0,u:()=>`https://www.egonzehnder.com/open-positions?q=${t0}`},
      {n:"Heidrick",i:"💎",s:"Leadership",aw:0,u:()=>`https://www.heidrick.com/en/open-positions?q=${t0}`},
      {n:"Russell Reynolds",i:"🔹",s:"C-Suite Global",aw:0,u:()=>`https://www.russellreynolds.com/en/open-positions?q=${t0}`},
      {n:"Odgers",i:"🎯",s:"Intl. C-Level",aw:0,u:()=>`https://www.odgersberndtson.com/de/offene-stellen?q=${t0}`},
      {n:"Page Executive",i:"📄",s:"CIO/CTO Europa",aw:0,u:()=>`https://www.pageexecutive.com/jobs/${t0}/europe`},
      {n:"Headgate",i:"🖥️",s:"#1 IT C-Level",aw:1,u:()=>`https://head-gate.de/offene-positionen/`},
      {n:"TechMinds",i:"🤖",s:"IT C-Level 14–30d",aw:1,u:()=>`https://techminds.de/jobs?q=${t0}&location=${l}`},
      {n:"Nigel Wright",i:"🇬🇧",s:"CIO/CTO Spezialist",aw:0,u:()=>`https://www.nigelwright.com/de/cio-headhunter-deutschland`},
      {n:"CareerTeam",i:"💡",s:"Digital Executive",aw:0,u:()=>`https://www.careerteam.de/de-roles/cio`},
      ...
      {n:"Kienbaum",i:"🔷",s:"DACH Exec Search",aw:0,u:()=>`https://www.kienbaum.com/de/jobs/?search=${t0}`},
      {n:"Kontrast",i:"🔌",s:"CIO/CTO seit 1993",aw:0,u:()=>`https://www.kontrast-gmbh.de/de/stellenangebote/?q=${t0}`},
      {n:"HAPEKO",i:"🔑",s:"C-Level & IT",aw:0,u:()=>`https://www.hapeko.de/jobs/?s=${t0}`},
